...
create table users (
  ...
  CONSTRAINT fk_org FOREIGN KEY (org_id) REFERENCES orgs(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table schedules (
  ...
  CONSTRAINT fk_users FOREIGN KEY (owner) REFERENCES users(id) ON DELETE CASCADE ON UPDATE CASCADE
);
